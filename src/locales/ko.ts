...
const ko: TranslationKeys = {
  ...
  schedule: {
    ...
    endDateTime: '종료일시',
    allDay: '하루종일',
    scheduleCount: '{count}개의 일정',
    participants: '참여자',
    createdBy: '작성자',
    loadFailed: '일정을 불러올 수 없습니다',
    fillRequired: '제목과 시작 일시를 입력해주세요',
    ...
    invalidEndDate: '유효하지 않은 종료 날짜입니다',
    endDateBeforeStart: '종료 날짜는 시작 날짜보다 이후여야 합니다',
    created: '일정이 생성되었습니다',
    createFailed: '일정 생성에 실패했습니다',
    updated: '일정이 수정되었습니다',
    ...
    before2hour: '2시간 전',
    before1day: '1일 전',
    repeatInterval: '반복 간격 (분)',
    repeatCount: '반복 횟수',
    repeatCountPlaceholder: '반복 횟수 (1-100)',
    interval5min: '5분',
    interval10min: '10분',
    interval15min: '15분',
    interval30min: '30분',
